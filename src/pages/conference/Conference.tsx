                ...
                <div className="flex justify-center items-center p-8">
                    <div className="flex flex-col text-primaryType bg-primaryBackground">
                        ...
                        <div className="p-4 pt-8 mb-4">
                            ...
                            <p className="font-bold mb-4">Arriving from O'Hare International Airport (CTA Blue Line)</p>
                            ...
                            <p className="font-bold mb-4">Arriving from Midway International Airport (CTA Orange Line)</p>
                            <ul className="list-disc pl-4 mb-4">
