...
import PromtBattleDemo from "./pages/aiPromtBattleDemo/PromptBattleDemo";
    ...
    <WagmiConfig config={wagmiConfig}>
      <ConnectKitProvider>
        ...
        <Routes>
          ...
          <Route
            path={links.sitePaths.hackerTicketRedirect}
            element={<HackerTicketRedirect />}
          />
          <Route path={links.sitePaths.faucet} element={<Faucet />} />
          <Route path={links.sitePaths.showcase} element={<Showcase />} />
          <Route
            path={links.sitePaths.holidayCollectible}
            element={<HolidayCollectibleMint />}
          />
          <Route path={links.sitePaths.community} element={<Community />} />
          <Route
            path={links.sitePaths.promptBattleDemo}
            element={<PromtBattleDemo />}
          />
        </Routes>
        <Footer />
      </ConnectKitProvider>
