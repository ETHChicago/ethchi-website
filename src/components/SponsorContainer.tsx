...
function SponsorCard({logo, url}: ISponsorCard) {
    return (
            <a href={url}>
                <div className="flex justify-center items-center h-full w-full bg-transparent p-2 rounded-xl outline hover:bg-neutral-900 ease-in duration-100 shadow-2xl">
                    <img
                        src={logo}
                        alt="sponsor logo"
                        width={200}
